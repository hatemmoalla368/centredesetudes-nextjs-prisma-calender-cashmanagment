...
export const POST = authMiddleware(async (request) => {
  try {
    ...
    const { clientName, clientAddress, invoiceNumber, date, scheduleIds, items, grandTotal,taxAmount, taxRate, total } = data;
...
export const DELETE = authMiddleware(async (request, { params }) => {
  try {
    ...
    console.log('Unlinked schedules:',updatedSchedules); // Enhanced logging
