    ...
    : '0.000'} TND
            ...
            <tfoot>
              <tr>
                ...
                <td className="text-end">{invoice.total.toFixed(3)} TND</td>
              </tr>
              <tr>
                <td colSpan="4" className="text-end"><strong>TVA ({invoice.taxRate}%):</strong></td>
                <td className="text-end">{invoice.taxAmount.toFixed(3)} TND</td>
              </tr>
              <tr>
              ...
              <tr className="table-active">
                ...
                <td className="text-end"><strong>{invoice.grandTotal.toFixed(3)} TND</strong></td>
              </tr>
            </tfoot>
          </Table>
