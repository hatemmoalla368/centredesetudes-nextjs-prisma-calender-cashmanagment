...
const InvoicesList = () => {
  ...
  const [total, setTimbreFiscale]= useState(1)
     ...
     const grandTotal= subtotal+ taxRate+timbreFiscal
      ...
      const items = selectedSchedules.map((id) => {
        ...
        return {
          ...
          discount:discount,
          total: pricePerSchedule-discount,
        };
      });
