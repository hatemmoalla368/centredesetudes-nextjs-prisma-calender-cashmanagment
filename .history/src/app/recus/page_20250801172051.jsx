...
import { Button as BootstrapButton, Container, Table, Form, Modal, FormCheck, Spinner, Row } from 'react-bootstrap';
...
const ReceiptsList = () => {
  ...
  const [companyLogo, setCompanyLogo] = useState(COMPANY_INFO.logo);
  const [companyAddress, setCompanyAddress] = useState(COMPANY_INFO.address);
  const [companyPhone, setCompanyPhone] = useState(COMPANY_INFO.phone);
  const [companyEmail, setCompanyEmail] = useState(COMPANY_INFO.email);
  const [matriculeFiscale, setMatriculeFiscale] = useState(COMPANY_INFO.matricule);
  ...
  const handleOpenImportModal = () => {
    ...
    setPlace('Tunis');
    setCompanyName(COMPANY_INFO.name);
    setCompanyLogo(COMPANY_INFO.logo);
    setCompanyAddress(COMPANY_INFO.address);
    setCompanyPhone(COMPANY_INFO.phone);
    setCompanyEmail(COMPANY_INFO.email);
    setMatriculeFiscale(COMPANY_INFO.matricule);
      ...
      <Modal show={showImportModal} onHide={() => setShowImportModal(false)} size="lg">
        ...
        <Modal.Body>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="text"
              placeholder="Entrer l'URL du logo"
              value={companyLogo}
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="text"
              placeholder="Entrer le téléphone de l'entreprise"
              value={companyPhone}
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="text"
              placeholder="Entrer le matricule fiscale"
