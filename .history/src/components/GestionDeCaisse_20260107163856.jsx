...
const GestionDeCaisse = () => {
  ...
  return (
    <div className="container my-4">
          ...
          <Card className="mt-3">
            <Card.Body>
              ...
              <Form onSubmit={(e) => handleSubmit(e, generalTransaction)}>
                {/* ... Keep the existing form fields for general transaction ... */}
              </Form>
            </Card.Body>
          </Card>
        </Tab>
          ...
          <Card className="mt-3">
            <Card.Body>
              ...
              <Form onSubmit={(e) => handleSubmit(e, classroomTransaction)}>
                {/* ... Keep the existing form fields for classroom transaction ... */}
              </Form>
            </Card.Body>
          </Card>
        </Tab>
          ...
          <Card className="mt-3">
            <Card.Body>
              ...
              <Form onSubmit={(e) => handleSubmit(e, studentTransaction)}>
                {/* ... Keep the existing form fields for student transaction ... */}
              </Form>
            </Card.Body>
          </Card>
        </Tab>
          ...
          <Card className="mt-3">
            <Card.Body>
              ...
              <Form onSubmit={(e) => handleSubmit(e, teacherPayment)}>
                {/* ... Keep the existing form fields for teacher payment ... */}
              </Form>
            </Card.Body>
          </Card>
        </Tab>
      ...
      {/* Edit Modal (keep the existing edit modal) */}
        ...
        <Modal.Body>
          {currentTransaction && (
            <Form onSubmit={(e) => handleSubmit(e, currentTransaction, true)}>
              {/* ... Keep the existing edit form fields ... */}
            </Form>
          )}
        </Modal.Body>
      </Modal>
